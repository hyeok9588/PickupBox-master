...
public class DialogMap extends AppCompatActivity  implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    private String Dis, Dur; //소요시간 소요거리
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = (TextView)findViewById(R.id.DDtext2);
        btnOkay = (Button)findViewById(R.id.btnOkay);

        //AdResult로 데이터 넘기기
        final Intent intentInfo = new Intent(getApplicationContext(),AddResult.class);

        intentInfo.putExtra("ssBoxName",getIntent().getStringExtra("sessBoxName"));
        intentInfo.putExtra("ssBoxSize",getIntent().getStringExtra("sessBoxSize"));
        intentInfo.putExtra("ssPickupTime",getIntent().getStringExtra("sessPickupTime"));
        intentInfo.putExtra("ssBoxPrice",getIntent().getStringExtra("sessBoxPrice"));
        intentInfo.putExtra("ssMyLatitude",getIntent().getStringExtra("myLatitude"));
        intentInfo.putExtra("ssMyLongitude",getIntent().getStringExtra("myLongitude"));
        ...
        btnOkay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentInfo.putExtra("ssDestLatitude",DestLat.toString());
                intentInfo.putExtra("ssDestLongitude",DestLong.toString());
                intentInfo.putExtra("ssDuration",Dur);
                intentInfo.putExtra("ssDistance",Dis);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        list = getIntent().getParcelableArrayListExtra("LocalList2");
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                if (MarkerPoints.size()==1){
                    ...
                    DestLat = laln.latitude;
                    DestLong = laln.longitude;
                    ...
                    for (int i = 0; i < MarkerPoints.size() - 1; i++) {
                        ...
                        DialogMap.fetchUrl fUrl = new DialogMap.fetchUrl(); // fetch할 클래스 생성
                        fUrl.execute(url); // url fetch
                    }

                 
                } else if (MarkerPoints.size()>1){
                    Toast.makeText(getApplicationContext(),"도착 위치가 이미 설정 되었습니다.",Toast.LENGTH_SHORT).show();
...
//            startActivity(MyIntent);
            ...
            DialogMap.ParserTask parserTask = new DialogMap.ParserTask();
