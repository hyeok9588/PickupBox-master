...
public class AddResult extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng laln1 = new LatLng(Dmylat, Dmylong);
        MarkerPoint.add(laln1);

        LatLng laln2 = new LatLng(Ddestlat, Ddestlong);
        ...
        btnDBplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //firebase에 저장
                mDatabase.child("BoxList").push().setValue(result); //push 사용으로 timestamp 값 들어감.
...
*/
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AddBox.class);
                startActivity(intent);
            }
        });
