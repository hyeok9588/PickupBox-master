...
public class Frag4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*https://blog.naver.com/willowtr22/221794755316*/  //참고 블로그

        if (LOG_INOUT == 1){ //로그인 되어있다면
            Log.d("테스트1",Boolean.toString(chck));
            if (CheckFile() == true) {
                ...
                imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Glide.with(Frag4.this).load(uri).into(imageView);
               ...
               /* Button bt4=(Button)v.findViewById(R.id.btn_start);
      ...
      /*  btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ImageView iv2 = (ImageView)getView().findViewById(R.id.imageView2);
    ...
    private boolean CheckFile(){
        ...
        /*boolean a = imageRef.getName().contains("_start.png");  //사용자의 아이디가 포함되어있다면?
        Log.d("test",String.valueOf(imageRef.getName()));
        if(a==true){
            Toast.makeText(getContext(), "이미지 존재" ,Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(getContext(), "이미지 없음", Toast.LENGTH_SHORT).show();
    ...
    private void uploadFile() {
        if (filePath != null) {
            ...
            //Date now = new Date();
            String filename = userName+"_start.png";
