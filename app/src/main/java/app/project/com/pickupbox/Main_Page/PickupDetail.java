...
public class PickupDetail extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    String b_latitude, b_longitude, b_boxName, b_pickupTime, b_duration, b_distance, b_boxSize, b_boxPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDetailPrice.setText(b_boxPrice);

        NumberPicker picker = findViewById(R.id.number_picker);

        int box_price = Integer.parseInt(b_boxPrice);


        String[] n_price = new String[8];

        int nums = box_price +  1200;
        //Toast.makeText(this, String.valueOf(nums), Toast.LENGTH_SHORT).show();




        //String[] data = new String[]{"4,500원", "5,000원","5,500원", "6,000원", "6,500원", "7,000원"};
        ...
        btnDetailDeal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(getApplicationContext(), DealPopup.class);
