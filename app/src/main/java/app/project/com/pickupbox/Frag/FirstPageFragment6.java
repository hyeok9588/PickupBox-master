...
public class FirstPageFragment6 extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dataList = new ArrayList<>(); //article 객체를 담을 어레이 리스트 ( 어뎁터 쪽으로)
        ...
        listView.setAdapter(new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1,
                new String[]{"GS25 목동점", "GS25 염창점", "GS25 강남점", "GS25 이대점", "GS25 신촌점", "GS25 홍대점", "GS25 가야점", "GS25 동덕점"}));
    ...
    private void updateValuesFromBundle(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            // Bundle로 mRequestingLocationUpdates 업데이트 하고,

            // 위/경도를 보여주는 UI를 업데이트 하자.
